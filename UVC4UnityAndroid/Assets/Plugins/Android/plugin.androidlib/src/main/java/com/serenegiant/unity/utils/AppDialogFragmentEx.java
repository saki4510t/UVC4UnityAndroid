...
public abstract class AppDialogFragmentEx extends DialogFragment {
	private static final String TAG = AppDialogFragmentEx.class.getSimpleName();

	protected static final String ARGS_KEY_REQUEST_CODE = "requestCode";
	protected static final String ARGS_KEY_ID_TITLE = "title_id";
	protected static final String ARGS_KEY_ID_MESSAGE = "message_id";
	protected static final String ARGS_KEY_TITLE = "title";
	protected static final String ARGS_KEY_MESSAGE = "message";
