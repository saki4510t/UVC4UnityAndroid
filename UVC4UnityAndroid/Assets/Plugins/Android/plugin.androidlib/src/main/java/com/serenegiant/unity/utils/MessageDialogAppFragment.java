...
public class MessageDialogAppFragment extends AppDialogFragmentEx {
//	private static final boolean DEBUG = false;	// FIXME 実働時はfalseにすること
	...
	public static interface MessageDialogListener {
		public void onMessageDialogResult(
			@NonNull final MessageDialogAppFragment dialog, final int requestCode,
	 ...
	 */
	public static MessageDialogAppFragment showDialog(
		@NonNull final Activity parent, final int requestCode,
		@StringRes final int id_title, @StringRes final int id_message,
		@NonNull final String[] permissions) throws IllegalStateException {

		final MessageDialogAppFragment dialog
	...
	public static MessageDialogAppFragment newInstance(
		...
		final MessageDialogAppFragment fragment = new MessageDialogAppFragment();
	...
	private void callOnMessageDialogResult(final boolean result)
		...
		try {
			mDialogListener.onMessageDialogResult(
				MessageDialogAppFragment.this,
				requestCode, (permissions != null ? permissions : new String[0]), result);
